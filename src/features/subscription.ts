...
import type {
	...
	FetchResponseDataT,
	ListSubscriptionQueryParamsT,
	ListSubscriptionResponseDataT,
	SubscriptionT,
...
export class Subscription {
	 ...
	 */
	list(
		params?: ListSubscriptionQueryParamsT,
	): Promise<PaginatedResponseT<ListSubscriptionResponseDataT>> {
		this.logger?.info("list => sending request to list subscriptions");
		return this.apiClient.get<
			PaginatedResponseT<ListSubscriptionResponseDataT>
		>(SUBSCRIPTION_PATH, params);
	}
